...
as $$
  insert into public.clients (
    ...
    p_record->>'full_name',
    p_record->>'phone',
    nullif(p_record->>'mobile_phone', ''),
    nullif(p_record->>'email', ''),
    nullif(p_record->>'social_media', ''),
  ...
  on conflict (phone) do update set
    ...
    mobile_phone = coalesce(excluded.mobile_phone, public.clients.mobile_phone),
    email = coalesce(excluded.email, public.clients.email),
    social_media = coalesce(excluded.social_media, public.clients.social_media),
